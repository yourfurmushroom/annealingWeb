...
function LoginForm() {
  ...
  return (
    <>
      <InputForm name="Username" icon={userIcon} value={username} onChange={(e) => setUsername(e.target.value)} className="mt-3" />
      <InputForm name="Password" icon={passwordIcon} value={password} onChange={(e) => setPassword(e.target.value)} className="mt-3" />
      <InputForm name="Confirm Password" icon={passwordIcon} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className="mt-3" />      
